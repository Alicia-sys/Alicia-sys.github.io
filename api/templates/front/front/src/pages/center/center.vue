	...
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="info-item6" v-if="userTableName=='yonghu'">
				...
				<div class="text">{{sessionForm.yonghuleixing}}</div>
			</div>
		...
		<el-tabs class="center-tabs" tab-position="left" @tab-click="handleClick">
			<el-tab-pane label="个人中心">
				<el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
					...
					<el-form-item class="center-item" v-if="userTableName=='yonghu'" label="用户类型" prop="yonghuleixing">
						<el-select v-model="sessionForm.yonghuleixing" placeholder="请选择用户类型" >
	...
	export default {
		...
		methods: {
			init() {
				...
				if ('yonghu' == this.userTableName) {
					this.dynamicProp.yonghuleixing = '教师,学生'.split(',');
				}
			},
			setSession(){
