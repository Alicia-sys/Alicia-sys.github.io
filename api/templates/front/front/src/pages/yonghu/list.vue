...
<script>
	export default {
		...
		async created() {
			...
			this.selectOptionsList.push({name:'用户类型',list:this.yonghuleixingOptions,tableName: 'yonghuleixing',check: -1})
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.yonghuleixing != '') searchWhere.yonghuleixing = this.formSearch.yonghuleixing;
