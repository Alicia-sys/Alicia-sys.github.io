	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于Python人脸识别的智能实验室门禁管理系统</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='yonghu'" prop="yonghuleixing">
						<div class="label" :class="changeRules('yonghuleixing')?'required':''">用户类型：</div>
						<el-select v-model="registerForm.yonghuleixing" placeholder="请选择用户类型" >
							<el-option
