...
# 注册接口
@main_bp.route("/pythonek97261k/storeup/register", methods=['POST'])
def pythonek97261k_storeup_register():
...
# 登录接口
@main_bp.route("/pythonek97261k/storeup/login", methods=['GET','POST'])
def pythonek97261k_storeup_login():
...
# 登出接口
@main_bp.route("/pythonek97261k/storeup/logout", methods=['POST'])
def pythonek97261k_storeup_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythonek97261k/storeup/resetPass", methods=['POST'])
def pythonek97261k_storeup_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/pythonek97261k/storeup/session", methods=['GET'])
def pythonek97261k_storeup_session():
...
# 分类接口（后端）
@main_bp.route("/pythonek97261k/storeup/page", methods=['GET'])
def pythonek97261k_storeup_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/pythonek97261k/storeup/autoSort", methods=['GET'])
def pythonek97261k_storeup_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/pythonek97261k/storeup/query", methods=['GET'])
def pythonek97261k_storeup_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythonek97261k/storeup/list", methods=['GET'])
def pythonek97261k_storeup_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/pythonek97261k/storeup/save", methods=['POST'])
def pythonek97261k_storeup_save():
...
# 添加接口（前端）
@main_bp.route("/pythonek97261k/storeup/add", methods=['POST'])
def pythonek97261k_storeup_add():
    request.operation = "新增收藏表"#封装日志内容
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
...
# 踩、赞接口
@main_bp.route("/pythonek97261k/storeup/thumbsup/<id_>", methods=['GET'])
def pythonek97261k_storeup_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/pythonek97261k/storeup/info/<id_>", methods=['GET'])
def pythonek97261k_storeup_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
...
# 获取详情信息（前端）
@main_bp.route("/pythonek97261k/storeup/detail/<id_>", methods=['GET'])
def pythonek97261k_storeup_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = storeup.getbyid(storeup, storeup, int(id_))
...
# 更新接口
@main_bp.route("/pythonek97261k/storeup/update", methods=['POST'])
def pythonek97261k_storeup_update():
...
# 删除接口
@main_bp.route("/pythonek97261k/storeup/delete", methods=['POST'])
def pythonek97261k_storeup_delete():
...
# 投票接口
@main_bp.route("/pythonek97261k/storeup/vote/<int:id_>", methods=['POST'])
def pythonek97261k_storeup_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= storeup.getbyid(storeup, storeup, int(id_))
...
#获取所有记录列表
@main_bp.route("/pythonek97261k/storeup/lists", methods=['GET'])
def pythonek97261k_storeup_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
