...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/pythonek97261k/examusers/login" ,
            "/pythonek97261k/examusers/register",
            '/pythonek97261k/defaultuser/login',
            '/pythonek97261k/users/login',
            '/pythonek97261k/forecast',
        ]  # 免认证list
        ...
        post_list = [
            '/pythonek97261k/defaultuser/register',
            '/pythonek97261k/defaultuser/login',
            '/pythonek97261k/users/register',
            '/pythonek97261k/users/login',
            "/pythonek97261k/examusers/login" ,
            "/pythonek97261k/examusers/register"
        ]  # 免认证list
