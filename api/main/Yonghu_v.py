...
# 注册接口
@main_bp.route("/pythonek97261k/yonghu/register", methods=['POST'])
def pythonek97261k_yonghu_register():
...
# 登录接口
@main_bp.route("/pythonek97261k/yonghu/login", methods=['GET','POST'])
def pythonek97261k_yonghu_login():
...
# 人脸登录接口
@main_bp.route("/pythonek97261k/yonghu/faceLogin", methods=['GET','POST'])
def pythonek97261k_yonghu_faceLogin():
    if request.method == 'GET' or request.method == 'POST':#get、post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
        req_dict = session.get("req_dict")
...
# 登出接口
@main_bp.route("/pythonek97261k/yonghu/logout", methods=['POST'])
def pythonek97261k_yonghu_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythonek97261k/yonghu/resetPass", methods=['POST'])
def pythonek97261k_yonghu_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/pythonek97261k/yonghu/session", methods=['GET'])
def pythonek97261k_yonghu_session():
...
# 分类接口（后端）
@main_bp.route("/pythonek97261k/yonghu/page", methods=['GET'])
def pythonek97261k_yonghu_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/pythonek97261k/yonghu/autoSort", methods=['GET'])
def pythonek97261k_yonghu_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/pythonek97261k/yonghu/query", methods=['GET'])
def pythonek97261k_yonghu_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythonek97261k/yonghu/list", methods=['GET'])
def pythonek97261k_yonghu_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/pythonek97261k/yonghu/save", methods=['POST'])
def pythonek97261k_yonghu_save():
...
# 添加接口（前端）
@main_bp.route("/pythonek97261k/yonghu/add", methods=['POST'])
def pythonek97261k_yonghu_add():
    request.operation = "新增用户"#封装日志内容
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
...
# 踩、赞接口
@main_bp.route("/pythonek97261k/yonghu/thumbsup/<id_>", methods=['GET'])
def pythonek97261k_yonghu_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/pythonek97261k/yonghu/info/<id_>", methods=['GET'])
def pythonek97261k_yonghu_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
...
# 获取详情信息（前端）
@main_bp.route("/pythonek97261k/yonghu/detail/<id_>", methods=['GET'])
def pythonek97261k_yonghu_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = yonghu.getbyid(yonghu, yonghu, int(id_))
...
# 更新接口
@main_bp.route("/pythonek97261k/yonghu/update", methods=['POST'])
def pythonek97261k_yonghu_update():
...
# 删除接口
@main_bp.route("/pythonek97261k/yonghu/delete", methods=['POST'])
def pythonek97261k_yonghu_delete():
...
# 投票接口
@main_bp.route("/pythonek97261k/yonghu/vote/<int:id_>", methods=['POST'])
def pythonek97261k_yonghu_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= yonghu.getbyid(yonghu, yonghu, int(id_))
...
#获取所有记录列表
@main_bp.route("/pythonek97261k/yonghu/lists", methods=['GET'])
def pythonek97261k_yonghu_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
